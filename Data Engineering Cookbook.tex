...
Running them in a completely pre-configured environment. You don’t need to think about stuf,f you go to the Docker library you search for Deep Learning, GPU and Python.
...
\end{tabular}
\captionof{table}{Podcast: \#102 Apache Spark Week Day 2} %\label{tbl:spotifycasestudy}
\end{table}
