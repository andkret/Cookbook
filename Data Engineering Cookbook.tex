\documentclass[12pt]{scrartcl} %use komascript instead of just article
...
\subtitle{How To Master The Plumbing Of Data Science}
...
\section{The Basic Skills}

\section{Learn to Write Code}
...
\section {My Big Data Platform Blueprint -- available}
...
\paragraph{THE BLUEPRINT -- available}
...
\subsection{Analyse / Process -- available}
...
\subsubsection{Stream and Batch processing -- available}

\paragraph{Batch Processing:} Ask the big questions. Remember your last yearly tax statement?
...
\paragraph{Stream Processing:} Gain instant insight into your data.
...
\subsubsection{Super important for REST APIs}
\subsubsection{How is it used for logging and processing logs}
...
\subsubsection{How does MapReduce work -- available}
...
\subsubsection{What is the limitation of MapReduce? -- available}
...
\subsubsection{What is the difference to MapReduce? -- available}
...
\subsubsection{How does Spark fit to Hadoop? -- available}
...
\subsubsection{Available Languages -- available}
...
\subsubsection{How to do stream processing}
\subsubsection{How to do batch processing}
\subsubsection{How does Spark use data from Hadoop -- available}
...
\subsubsection{What is a RDD and what is a DataFrame?}
\subsubsection{Spark coding with Scala}
\subsubsection{Spark coding with Python}
\subsubsection{How and why to use SparkSQL?}
\subsubsection{Machine Learning on Spark? (Tensor Flow)}
...
\subsubsection{Spark Setup -- available}
...
\subsubsection{Spark Resource Management -- available}
...
\subsection{Message queues with Apache Kafka}

\subsubsection{Why a message queue tool?}
\subsubsection{Kakfa architecture}
\subsubsection{What are topics}
\subsubsection{What does Zookeeper have to do with Kafka}
\subsubsection{How to produce and consume messages}
...
\subsubsection{Training and Applying models}
\subsubsection{What is deep learning}
\subsubsection{How to do Machine Learning in production | available}
...
\subsubsection{Why machine learning in production is harder then you think -- available}
...
\subsubsection{How to convince people machine learning works | available}
...
\subsubsection{ODBC/JDBC Server Connections}
...
\subsubsection{Android \& IOS basics}
\subsubsection{How to design APIs for mobile apps}
 
\subsection{How to use Webservers to display content}
...
\subsubsection{Quliksense}
 
\subsection{Identity \& Device Management}

\subsubsection{What is a digital twin?}
...
\subsection{Data Sciecne @Zalando}

 \section{DEV/OPS}

\subsection{Hadoop}
Listen to an introduction to Hadoop for Data Scientists:  \cite{einstein}


\subsubsection{Hadoop Cluster setup and management with Cloudera Manager (for example)}
\subsubsection{Spark code from coding to production}
\subsubsection{How to monitor and manage data processing pipelines}
\subsubsection{Oozie}
\subsubsection{Airflow Application management}
\subsubsection{Creating Statistics with Spark and Kafka}
